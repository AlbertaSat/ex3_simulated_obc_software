...
#include <BurnwireTester/Top/BurnwireTesterTopology.hpp>
...
static void signalHandler(int signum) {
    BurnwireTester::stopSimulatedCycle();
}
...
int main(int argc, char* argv[]) {
    ...
    BurnwireTester::TopologyState inputs;
    ...
    BurnwireTester::setupTopology(inputs);
    BurnwireTester::startSimulatedCycle(1000);  // Program loop cycling rate groups at 1Hz
    BurnwireTester::teardownTopology(inputs);
    (void)printf("Exiting...\n");
    return 0;
}
