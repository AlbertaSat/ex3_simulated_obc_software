// ======================================================================
// \title  BurnwireTesterTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef BURNWIRETESTER_BURNWIRETESTERTOPOLOGY_HPP
#define BURNWIRETESTER_BURNWIRETESTERTOPOLOGY_HPP
// Included for access to BurnwireTester::TopologyState and BurnwireTester::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <BurnwireTester/Top/BurnwireTesterTopologyDefs.hpp>

// Remove unnecessary BurnwireTester:: qualifications
using namespace BurnwireTester;
 ...
 * BurnwireTester::TopologyState see: BurnwireTesterTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type BurnwireTester::TopologyState see: BurnwireTesterTopologyDefs.hpp.
 *
