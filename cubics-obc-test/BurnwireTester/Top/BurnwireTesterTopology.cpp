// ======================================================================
// \title  BurnwireTesterTopology.cpp
// \brief cpp file containing the topology instantiation code
//
// ======================================================================
// Provides access to autocoded functions
#include <BurnwireTester/Top/BurnwireTesterTopologyAc.hpp>
#include <BurnwireTester/Top/BurnwireTesterPacketsAc.hpp>
...
void configureTopology() {
    ...
    //tlmSend.setPacketList(BurnwireTesterPacketsPkts, BurnwireTesterPacketsIgnore, 1);

}

// Public functions for use in main program are namespaced with deployment name BurnwireTester
...
void startSimulatedCycle(U32 milliseconds) {
    ...
    // Main loop
    while (cycling) {
        BurnwireTester::blockDrv.callIsr();
