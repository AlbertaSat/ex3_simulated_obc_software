...
namespace BurnwireTester {
  ...
  static const Svc::TlmPacketizerPacket LedChannels = { LedChannelsList, 8, 1, FW_NUM_ARRAY_ELEMENTS(LedChannelsList) };



  const Svc::TlmPacketizerPacketList BurnwireTesterPacketsPkts = {
      {
         &CDH,
         &CDHErrors,
         &DriveTlm,
  ...
  const Svc::TlmPacketizerPacket BurnwireTesterPacketsIgnore = { ignoreList, 0, 0, FW_NUM_ARRAY_ELEMENTS(ignoreList) };

} // end namespace BurnwireTester
