...
#include <arpa/inet.h> //For socket connection (TCP)
#include <errno.h>
#include <stdio.h>
#include <string.h>
#include <unistd.h>
...
class DeployablesInterface : public DeployablesInterfaceComponentBase {
  ...
  public:
    ...
    //!
    DeployablesInterface(const char *const compName /*!< The component name*/
    );
