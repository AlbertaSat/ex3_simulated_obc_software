// ======================================================================
// \title  SimulationDeploymentTopology.cpp
// \brief cpp file containing the topology instantiation code
//
// ======================================================================
// Provides access to autocoded functions
#include <SimulationDeployment/Top/SimulationDeploymentTopologyAc.hpp>
#include <SimulationDeployment/Top/SimulationDeploymentPacketsAc.hpp>
...
void configureTopology() {
    ...
    //tlmSend.setPacketList(SimulationDeploymentPacketsPkts, SimulationDeploymentPacketsIgnore, 1);
...
// Public functions for use in main program are namespaced with deployment name SimulationDeployment
...
void startSimulatedCycle(U32 milliseconds) {
    ...
    // Main loop
    while (cycling) {
        SimulationDeployment::blockDrv.callIsr();
