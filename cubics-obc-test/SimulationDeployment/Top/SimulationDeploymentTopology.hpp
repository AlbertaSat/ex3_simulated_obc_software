// ======================================================================
// \title  SimulationDeploymentTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef SIMULATIONDEPLOYMENT_SIMULATIONDEPLOYMENTTOPOLOGY_HPP
#define SIMULATIONDEPLOYMENT_SIMULATIONDEPLOYMENTTOPOLOGY_HPP
// Included for access to SimulationDeployment::TopologyState and SimulationDeployment::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <SimulationDeployment/Top/SimulationDeploymentTopologyDefs.hpp>

// Remove unnecessary SimulationDeployment:: qualifications
using namespace SimulationDeployment;
 ...
 * SimulationDeployment::TopologyState see: SimulationDeploymentTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type SimulationDeployment::TopologyState see: SimulationDeploymentTopologyDefs.hpp.
 *
