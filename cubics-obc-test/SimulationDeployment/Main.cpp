...
#include <SimulationDeployment/Top/SimulationDeploymentTopology.hpp>
...
static void signalHandler(int signum) {
    SimulationDeployment::stopSimulatedCycle();
}
...
int main(int argc, char* argv[]) {
    ...
    SimulationDeployment::TopologyState inputs;
    ...
    SimulationDeployment::setupTopology(inputs);
    SimulationDeployment::startSimulatedCycle(1000);  // Program loop cycling rate groups at 1Hz
    SimulationDeployment::teardownTopology(inputs);
    (void)printf("Exiting...\n");
    return 0;
}
